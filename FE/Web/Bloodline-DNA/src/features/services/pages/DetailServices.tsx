        ...
        <section className="relative w-full h-[320px] md:h-[360px] lg:h-[400px] overflow-hidden bg-gradient-to-br from-[#0066CC] via-[#0052A3] to-[#003875]">
          ...
          <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute flex items-center justify-center w-12 h-12 rounded-full bottom-32 right-32 bg-white/10 animate-bounce" style={{animationDelay: '1s'}}>
              <ActivityIcon className="w-6 h-6 text-white/60" />
            </div>
                ...
                <div className="mb-6">
                  <Breadcrumb>
                    <BreadcrumbList className="text-white/90">
                      ...
                      <BreadcrumbItem>
                        <BreadcrumbLink href="/services" className="transition-colors duration-200 text-white/80 hover:text-white">
                          Dịch Vụ
                        </BreadcrumbLink>
                      </BreadcrumbItem>
                      <BreadcrumbSeparator className="text-white/60" />
                      <BreadcrumbItem>
                        <span className="text-[#00D4FF] font-semibold">{serviceData.title}</span>
                      </BreadcrumbItem>
                    </BreadcrumbList>
                  </Breadcrumb>
                </div>
