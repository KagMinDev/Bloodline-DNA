import { ArrowRightIcon, HeartIcon, ShieldIcon, ActivityIcon, UserCheckIcon, ClipboardCheckIcon, StethoscopeIcon } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 max-w-7xl">
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20 xl:mb-24">
          <div className="inline-block">
            ...
            <p className="text-base md:text-lg lg:text-xl xl:text-2xl text-gray-600 max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mx-auto leading-relaxed animate-fade-in-up animation-delay-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6 md:gap-8 lg:gap-10 xl:gap-12">
              ...
              >
                <div className="relative h-[250px] md:h-[280px] lg:h-[320px] xl:h-[350px] overflow-hidden">
                  ...
                  {card.hasOverlay && IconComponent && (
                    <div className="absolute inset-0 bg-app-primary/85 rounded-t-xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-100 scale-95">
                      <IconComponent className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 xl:w-20 xl:h-20 text-white animate-pulse" />
                    </div>
                  )}
                  ...
                  {card.hasFloatingIcon && IconComponent && (
                    <div className="absolute w-16 h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 xl:w-24 xl:h-24 bottom-[-32px] md:bottom-[-36px] lg:bottom-[-40px] xl:bottom-[-48px] right-[16px] md:right-[20px] lg:right-[24px] bg-gradient-to-br from-app-primary to-app-secondary rounded-full flex items-center justify-center shadow-xl transition-all duration-500 ease-out group-hover:bottom-[-28px] md:group-hover:bottom-[-32px] lg:group-hover:bottom-[-35px] xl:group-hover:bottom-[-40px] group-hover:scale-110 group-hover:rotate-12">
                      <IconComponent className="w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-10 xl:h-10 text-white group-hover:animate-bounce" />
                    </div>
                  )}

                  {/* Hover overlay with action */}
                  <div className="absolute inset-0 bg-app-primary/0 group-hover:bg-app-primary/10 transition-all duration-500 flex items-center justify-center opacity-0 group-hover:opacity-100">
                ...
                <CardContent className="pt-12 md:pt-14 lg:pt-16 xl:pt-20 px-4 md:px-5 lg:px-6 xl:px-8 pb-6 md:pb-7 lg:pb-8 xl:pb-10 relative">
                  {/* Content with staggered animation - responsive spacing */}
                  <div className="space-y-3 md:space-y-4 lg:space-y-5 xl:space-y-6">
                    <h3 className="font-bold text-lg md:text-xl lg:text-2xl xl:text-3xl text-app-primary group-hover:text-app-secondary transition-colors duration-300 leading-tight">
                      {card.title}
                    </h3>

                    <p className="text-sm md:text-base lg:text-lg text-gray-600 leading-relaxed line-clamp-3 group-hover:text-gray-700 transition-colors duration-300">
                      {card.description}
                    </p>
                    ...
                    <Button
                      variant="link"
                      className="p-0 h-auto text-app-secondary hover:text-app-primary font-semibold group/btn transition-all duration-300 text-sm md:text-base lg:text-lg"
                    >
                      <span className="border-b-2 border-transparent group-hover/btn:border-app-primary transition-all duration-300">
                        Tìm Hiểu Thêm
                      </span>
                      <ArrowRightIcon className="ml-2 h-3 w-3 md:h-4 md:w-4 lg:h-5 lg:w-5 transition-transform duration-300 group-hover/btn:translate-x-1" />
                    </Button>
                  </div>
        ...
        <div className="text-center mt-16 md:mt-20 lg:mt-24 xl:mt-28">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-6 md:p-8 lg:p-10 xl:p-12 rounded-2xl md:rounded-3xl text-white mx-auto max-w-4xl shadow-2xl">
            <h3 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-3 md:mb-4 lg:mb-6">Sẵn Sàng Bắt Đầu?</h3>
            <p className="text-base md:text-lg lg:text-xl xl:text-2xl opacity-90 mb-6 md:mb-8 lg:mb-10">Liên hệ với chúng tôi ngay hôm nay để đặt lịch tư vấn</p>
            <Button className="bg-white text-blue-600 hover:bg-yellow-400 hover:text-blue-800 font-semibold px-6 md:px-8 lg:px-10 xl:px-12 py-3 md:py-4 lg:py-5 xl:py-6 rounded-full text-sm md:text-base lg:text-lg xl:text-xl transition-all duration-300 hover:scale-105 shadow-lg">
              Đặt Lịch Hẹn
            </Button>
          </div>
        </div>
